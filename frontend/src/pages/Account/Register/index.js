...
function Register(props) {
    ...
    setConfirmPassword({
      ...
      errorMessage:
        confirmPassword !== password.value
          ? t("register.message.confirmPassword")
          : "",
    });
  };
  ...
  const handleOnSubmit = (e) => {
    ...
    if (username.isValid && password.isValid && confirmPassword.isValid) {
      AuthService.register(username.value, props.email, password.value).then(
        (res) => {
    ...
    <>
      ...
      <div className="ps-3 pe-3 w-100">
        <form onSubmit={(e) => handleOnSubmit(e)}>
          ...
          <button type="submit" className="signup-btn rounded-4 border-0">
